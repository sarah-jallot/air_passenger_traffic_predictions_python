...
3. 
Our observations correspond to the number of goals scored during n independent football games. And we know that they follow a Poisson law of parameter θ. 

The statistical model is M = { for k in N*, Pθ(X=k), θ>0}

We are trying to estimate this parameter θ. As the observations follow a Poisson law od parameter θ, we are trying to estimate the true average number of goals score during a football game. 
